...
const cardData = [
  {
    ...
    description:
      "Effortlessly integrate and manage blockchain data with cutting age API designed for seamless connectivity",
    color: "fuchsia",
  },
  {
    ...
    description:
      "Empower your applications with decentralized data solutions,ensuring and transparency at every step.",
    color: "lime",
  },
  {
    ...
    description:
      "Unlock the potentail of next-gen smart contracts with our robust and scalable API,tailored for modern blockchain needs",
    color: "cyan",
  },
  {
    ...
    description:
      "Integrate blockchain technology seamlessly into your projects, with minimal effort and maximum efficency",
    color: "violet",
  },
];
