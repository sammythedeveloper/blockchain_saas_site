    ...
    <section className=" py-24 ">
      ...
      <div>
        ...
        <div className=" flex flex-col text-xl text-zinc-400 mt-6 gap-6 ">
          <p>
            Blockforge is dedicated to supporting the evolution of the web3
            applications by delivering the necessary infrastructre and security
            for web3.
          </p>
          <p>
            Blockforge champions web3 for everyone. As a decentralized
            blockchain scaling platform, Blockforge enables developers to create
            scalable ,user-friendly apps with low transaction costs, all wjile
